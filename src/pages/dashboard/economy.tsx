...
export default function EconomyDashboard({ user }: IProps) {
    ...
    return (
        <>
            <Head>
                <title>4EgosBot Dashboard - Economy System</title>
                <meta name="description" content="Economy management overview" />
            </Head>
                ...
                <div className={dashStyles.serverSelection}>
                    ...
                    {userGuilds.length === 0 ? (
                        <div className={dashStyles.noServers}>
                            ...
                            <p>You need to have &quot;Manage Server&quot; permission to configure the economy system.</p>
                        ...
                        <div className={dashStyles.serverGrid}>
                            {userGuilds.map((guild) => (
                                <Link 
                                    key={guild.id}
                                    href={`/dashboard/guilds/${guild.id}?section=economy`}
                                ...
                                >
                                    ...
                                    <div className={dashStyles.serverInfo}>
                                        <h4>{guild.name}</h4>
                                        <p>Configure Economy Settings</p>
                                    </div>
