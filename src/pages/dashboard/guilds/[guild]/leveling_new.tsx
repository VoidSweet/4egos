      ...
      <div className="dark-content-body">
        <div className="dark-stats-grid">
          <div className="dark-stat-card">
            <div className="dark-stat-icon blue">📈</div>
            <div>
          ...
          <div className="dark-stat-card">
            <div className="dark-stat-icon green">⚡</div>
            <div>
          ...
          <div className="dark-stat-card">
            <div className="dark-stat-icon yellow">⏰</div>
            <div>
          ...
          <div className="dark-stat-card">
            <div className="dark-stat-icon purple">🎯</div>
            <div>
